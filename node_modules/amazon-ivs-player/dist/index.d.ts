...
export declare interface PlayerConfig {
     ...
     *
     * A function which keeps or removes a quality from the player.
     * This function runs after the player filters the quality list internally. For example, after we remove qualities with unsupported codecs.
     *
     * If true, the quality remains available.
     *
     * If false, the quality will not be auto selected, cannot be manually selected, and will not be returned by {@link Player.getQualities}.
     */
